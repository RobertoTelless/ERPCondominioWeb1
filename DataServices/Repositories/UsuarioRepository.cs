...
namespace DataServices.Repositories
{
    public class UsuarioRepository : RepositoryBase<USUARIO>, IUsuarioRepository
    {
        ...
        public USUARIO GetByEmailGeral(String email)
        {
            IQueryable<USUARIO> query = Db.USUARIO.Where(p => p.USUA_IN_ATIVO == 1);
            query = query.Where(p => p.USUA_NM_EMAIL == email);
            return query.FirstOrDefault();
        ...
        public USUARIO GetAdministrador(Int32? idAss)
        {
            ...
            query = query.Where(p => p.COND_CD_ID == idAss.Value);
            query = query.Include(p => p.CONDOMINIO);
            query = query.Include(p => p.PERFIL);
            query = query.Include(p => p.LOG);
            return query.FirstOrDefault();
        ...
        public List<USUARIO> ExecuteFilter(Int32? perfilId, String nome, String login, String email, Int32? cargoId, Int32? idAss)
        {
