...
namespace ApplicationServices.Interfaces
{
    public interface IUsuarioAppService : IAppServiceBase<USUARIO>
    {
        ...
        Int32 ValidateLogin(String email, String senha, out USUARIO usuario, Int32? idAss);
        ...
        Int32 GenerateNewPassword(String email, Int32? idAss);
        ...
        Int32 ExecuteFilter(Int32? perfilId, String nome, String login, String email, Int32? idCargo, Int32? idAss, out List<USUARIO> objeto);
