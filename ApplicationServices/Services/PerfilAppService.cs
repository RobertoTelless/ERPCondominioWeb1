...
namespace ApplicationServices.Services
{
    public class PerfilAppService : AppServiceBase<PERFIL>, IPerfilAppService
    {
        ...
        public Int32 ValidateCreate(PERFIL perfil, USUARIO usuario, Int32? idAss)
        {
            try
            {
                // Verifica existencia prévia
                if (_perfilService.GetByName(perfil.PERF_NM_PERFIL) != null)
                {
                    return 1;
                }
        ...
        public Int32 ValidateEdit(PERFIL perfil, PERFIL perfilAntes, USUARIO usuario, Int32? idAss)
        {
            try
            {
                // Verifica existencia prévia
        ...
        public Int32 ValidateDelete(PERFIL perfil, USUARIO usuario, Int32? idAss)
        {
            try
            {
